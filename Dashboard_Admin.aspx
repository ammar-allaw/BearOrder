<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_Admin.aspx.cs" Inherits="WebApplication7.Dashboard_Admin" %>
      ...
      <%--  <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="Dashboard_Admin_Form.aspx" class="waves-effect waves-dark"><i class="fa fa-edit"></i> Add Admin </a>
                    </li>
					<li>
